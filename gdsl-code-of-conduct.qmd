...
This document aims to set the expected principles to be used for making decisions within the Geographic Data Science Lab (GDSL) in an open, transparent, inclusive, collective and participatory manner that leverages on the diversity of the group. This document particularly concerns staff meetings; that is, meetings involving staff in research only, teaching & scholarship, and teaching & research appointments. This includes both permanent and non-permanent staff.

Any changes to this document must be considered following the steps described for Critical decisions below.

For all these decisions, the core GDSL principle is to promote discussion to arrive to a decision that represents the shared views from the members of the group. The core principle is to incorporate the best elements from the various suggested ideas in a consensual manner. Having constructive, transparent and open discussion will be the preferred first stage of the group as a forum to make decisions. All possible steps will be implemented so opposing alternatives meet on middle grounds, accommodating elements from their contrasting options. A vote on opposing alternatives will be viewed as a less preferred option.
...
-   The Geographic Data Science Lab (GDSL) is hereby referenced as GDSL.

# Section 2 Our Pledge

We as members and contributors of GDSL pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disabilities, ethnicity, gender identity and expression, level of experience, education, socioeconomic position (current or historic), nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
-   Meetings shall be open to all staff (including both tenured academics and research associates/fellows) of the GDSL.
-   Meetings shall be open to non-GDSL staff who may attend as observers with the permission of any GDSL member.
-   A representative of the GDSL PhDs will be welcome to attend.
...
-   Any member of GDSL may submit items of business for inclusion on the agenda to the Lead of Deputy Lead. All items submitted at least two business days prior to the meeting shall be placed on the agenda.
...
-   GDSL meetings will typically happen twice a month. GDSL meetings will be convened a minimum of once every term.
...
-   Any GDSL member can summon an extraordinary meeting by contacting the Lead or Deputy Lead.

-   All meetings will be recorded and stored online (e.g., via MS Teams) for any GDSL member who cannot attend, when possible.

-   Meetings will be hybrid in format, unless otherwise stated.
...
-   Non-critical decisions: These are decisions that will not impact GDSL as a collective or large segments of the group in any significant way. These include day-to-day decisions such as the cancelling or postponing of lab meetings, brown bag seminars and workshops.
...
The types of decisions identified above will be handled in specific ways as described below.
...
-   When there is a critical decision to be made, the Lead and Deputy Lead will be responsible to share a written account of the decision to be made via email or appropriate Teams channel before the staff meeting in which issues will be discussed and considered.
...
-   GDSL members can also provide non-vocal input via Teams or email directed at the Lead or Deputy Lead. The deadline to receive this input will be at 5pm during the day that the meeting took place.
...
2.  All staff members are authorized to vote. All members have equal voting rights.
...
7.  A minimum of 50% + 1 of GDSL members need to vote in order for the result to be valid. If a vote is considered as not valid, the voting period will be extended for an additional three days. By the end of this second round, a decision will be made considering the votes casted up to that point.
