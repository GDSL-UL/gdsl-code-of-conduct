...
-   GDSL meetings will typically happen bi-monthly. GDSL meetings will be convened a minimum of once every term.
...
- All meetings will be recorded and stored online (e.g., via MS Teams) for any GDSL member who cannot attend. 
...
7.  A minimum of fifteen GDSL members need to vote in order for the result to be valid. If a vote is considered as not valid, the voting period will be extended for an additional three days. By the end of this second round, a decision will be made considering the votes casted up to that point.
